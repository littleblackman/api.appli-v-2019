...
class GroupActivityControllerTest extends WebTestCase
{
    ...
    public function testCreate()
    {
        $this->clientAuthenticated->request(
            ...
            '{"date": "2018-11-20", "name": "Name", "start": "08:00:00", "end": "09:00:00", "lunch": true, "comment": "Comment", "location": 1, "sport": 1, "links": [{"pickupActivityId": 1}], "staff": [{"staffId": 1}]}'
        );
        ...
        $this->clientAuthenticated->request(
            ...
            array(),
            array('CONTENT_TYPE' => 'application/json'),
            '[{"date": "2018-11-20", "name": "Name", "start": "08:00:00", "end": "09:00:00", "lunch": true, "comment": "Comment", "location": 1, "sport": 1, "links": [{"pickupActivityId": 1}], "staff": [{"staffId": 1}]}, {"date": "2018-11-20", "name": "Name", "start": "08:00:00", "end": "09:00:00", "lunch": true, "comment": "Comment", "location": 1, "sport": 1, "links": [{"pickupActivityId": 1}], "staff": [{"staffId": 1}]}]'
        );
