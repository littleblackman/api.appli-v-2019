...
class ChildControllerTest extends WebTestCase
{
    ...
    public function testCreate()
    {
        $this->clientAuthenticated->request(
            ...
            '{"firstname": "Firstname", "lastname": "Lastname", "phone": "0123456789", "birthdate": "2018-01-01", "medical": "medical", "photo": "/url/photo", "links": [{"personId": "1", "relation": "Relation"}], "siblings": [{"siblingId": "1", "relation": "Relation"}]}'
        );
    ...
    public function testModify()
    {
        ...
        $this->clientAuthenticated->request(
            ...
            array(),
            array('CONTENT_TYPE' => 'application/json'),
            '{"firstname": "Firstname modifié", "lastname": "Lastname", "phone": "0123456789", "birthdate": "2018-01-01", "medical": "medical", "photo": "/url/photo", "links": [{"personId": "1", "relation": "Relation"}], "siblings": [{"siblingId": "1", "relation": "Relation"}]}'
        );
        $response = $this->clientAuthenticated->getResponse();
        $this->assertJsonResponse($response, 200);
