...
class PersonControllerTest extends WebTestCase
{
    ...
    /**
     * Tests display Person with its user's identifier
     */
    public function testDisplayIdentifier()
    {
        $this->clientAuthenticated->request('GET', '/person/display/' . $_ENV['ADMIN_IDENTIFIER']);
