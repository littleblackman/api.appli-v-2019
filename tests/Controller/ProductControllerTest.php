...
class ProductControllerTest extends WebTestCase
{
    ...
    public function testModify()
    {
        ...
        $this->clientAuthenticated->request(
            ...
            array(),
            array('CONTENT_TYPE' => 'application/json'),
            '{"family": "1", "season": "1", "nameFr": "name Fr modifié", "nameEn": "Name En modified", "descriptionFr": "Description Fr modifiée", "descriptionEn": "Description En modified", "quantity": 2, "priceTtc": "425.50", "transport": "false", "lunch": "false", "child": 1, "photo": "/path/to/picture-modified.jpg", "isLocationSelectable": "false", "isDateSelectable": "false", "isHourSelectable": "false", "isSportSelectable": "false", "visibility": "invisible", "hourDropin": "11:40:00", "hourDropoff": "12:40:00", "categories": [{"category": 1}], "components": [{"nameFr": "string", "nameEn": "string", "vat": 5.5, "priceHt": 150, "priceVat": 8.25, "priceTtc": 158.25, "quantity": 10, "totalHt": 1500.00, "totalVat": 82.50, "totalTtc": 1582.50}], "dates": [{"date": "2018-04-06"}], "hours": [{"start": "09:00:00", "end": "10:00:00"}], "locations": [{"location": "1"}], "sports": [{"sport": "1"}]}'
        );
        $response = $this->clientAuthenticated->getResponse();
        $this->assertJsonResponse($response, 200);
